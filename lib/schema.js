...
// FAQPage schema — per i rich snippet "Domande frequenti" su Google
function faqPage(site, faqs) {
  return {
    "@type": "FAQPage",
...
module.exports = { abs, localBusiness, websiteNode, serviceNode, breadcrumb, faqPage, jsonLd };
